...
rspeed = fabs ( hspeed )  ; 
  ...
  if ( fabs ( rspeed )  > 1.4 ) animOffset = 16 ; 
 
  if ( fabs ( rspeed )  > 3.4 ) animOffset = 32 ; 
...
partnerHang = false ; 
  ...
  if (  ( playerNum == 1 && gvPlayer2 && gvPlayer2 . anim == "fly" && hitTest ( shape , gvPlayer2 . shape )  )  ||  ( playerNum == 2 && gvPlayer && gvPlayer . anim == "fly" && hitTest ( shape , gvPlayer . shape )  )  )  { 
 anim = "monkey" ; 
frame = 0.0 ; 
hspeed = 0 ; 
vspeed = 0 ; 
