...
playSound ( sndFireball , 0 )  ; 
 var fx = 6 ;
  ...
  var randAngle = randInt ( 20 )  ;
  for (  var i = 0 ;
 i < 360 ; i += 20 )  { 
  var c = fireWeapon ( KonqiIceball , x + fx , y , 1 , id )  ;
...
frame = 0.0 ; 
 ...
 z < 10 ; z ++  )  { 
  ...
  var angleRadians = randInt ( 1000 )  * 2 * pi / 1000 ;
...
firetime = 12 ; 
  ...
  break ;  case "ice" :  if ( getcon ( "shoot" , "press" , true , playerNum )  )  { 
 playSound ( sndFireball , 0 )  ; 
 var fx = 6 ;
  if ( flip == 1 ) fx =  - 5 ; 
...
firetime = 12 ; 
  ...
  break ;  case "ice" :  if ( getcon ( "spec1" , "press" , true , playerNum )  )  { 
 playSound ( sndFireball , 0 )  ; 
 var fx = 6 ;
  if ( flip == 1 ) fx =  - 5 ; 
