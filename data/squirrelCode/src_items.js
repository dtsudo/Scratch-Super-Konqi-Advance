...
game . ps2 . weapon = "air" ; 
 ...
 deleteActor ( id )  ; 
  ...
  } ;  returnVal . draw = function (  ) { drawSprite ( sprAirFeather , frame , x - camx , y - camy )  ; 
 } ;  returnVal . _typeof = function (  ) {  return "AirFeather" ;
  } ; 
 } 
 returnVal.constructor(...arguments); returnVal.SQUIRREL_CLASS = squirrelClassFunction; return returnVal ;  };  squirrelClassFunction . vspeed =  - 2.0 ; 
 squirrelClassFunction . hspeed = 0.0 ; 
...
vspeed += lendirY ( speed , dir )  ; 
 ...
 if ( checkActor ( i . owner )  ) freed = actor [ i . owner ]  . playerNum ; 
  ...
  } ;  returnVal . draw = function (  ) { drawSpriteZ ( 4 , sprSulphurNimbus , an [ anim ]  [ wrap ( getFrames (  )  / 4 , 0 , an [ anim ]  . len (  )  - 1 )  ]  , x - camx , y - camy , 0 , flip )  ; 
