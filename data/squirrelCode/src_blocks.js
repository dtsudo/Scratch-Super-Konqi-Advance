...
tileSetSolid ( x , y , oldsolid )  ; 
 ...
 {     var foreachOutput1 = squirrelForEach( gvYetFoundItems );     while(true)     {        foreachOutput1.next();        if (foreachOutput1.isDone()) break; k = foreachOutput1.getKey(); i = foreachOutput1.getValue();  if ( i == id ) gvFoundItems [ k ] =  squirrelTypeOf ( this )  ; 
  ...
  if (  ( (gvPlayer[ ( "anim" ) ] !== undefined) )  )  if ( fabs ( gvPlayer . hspeed )  >= 4.5 &&  ( gvPlayer . anim == "slide" || gvPlayer . anim == "ball" )  )  if ( hitTest ( slideshape , gvPlayer . shape )  )  { 
 gvPlayer . vspeed = 0 ; 
deleteActor ( id )  ; 
newActor ( WoodChunks , x , y )  ; 
popSound ( sndBump , 0 )  ; 
...
fireWeapon ( BoxHit , x , y - 8 , 1 , id )  ; 
  ...
  if (  ( (gvPlayer[ ( "anim" ) ] !== undefined) )  )  if (  ( fabs ( gvPlayer . hspeed )  >= 4.5 ||  ( gvPlayer . stats . weapon == "earth" && gvPlayer . vspeed >= 2 )  )  &&  ( gvPlayer . anim == "slide" || gvPlayer . anim == "ball" )  )  if ( hitTest ( slideshape , gvPlayer . shape )  )  { 
 vspeed =  - 2 ; 
coins --  ; 
newActor ( CoinEffect , x , y - 16 )  ; 
popSound ( sndBump , 0 )  ; 
...
tileSetSolid ( x , y , oldsolid )  ; 
 ...
 {     var foreachOutput4 = squirrelForEach( gvYetFoundItems );     while(true)     {        foreachOutput4.next();        if (foreachOutput4.isDone()) break; k = foreachOutput4.getKey(); i = foreachOutput4.getValue();  if ( i == id ) gvFoundItems [ k ] =  squirrelTypeOf ( this )  ; 
  ...
  if (  ( (gvPlayer2[ ( "anim" ) ] !== undefined) )  )  if ( fabs ( gvPlayer2 . hspeed )  >= 4.5 &&  ( gvPlayer2 . anim == "slide" || gvPlayer2 . anim == "ball" )  )  if ( hitTest ( slideshape , gvPlayer2 . shape )  )  { 
 gvPlayer2 . vspeed = 0 ; 
deleteActor ( id )  ; 
newActor ( WoodChunks , x , y )  ; 
popSound ( sndBump , 0 )  ; 
...
fireWeapon ( BoxHit , x , y - 8 , 1 , id )  ; 
  ...
  if (  ( (gvPlayer2[ ( "anim" ) ] !== undefined) )  )  if (  ( fabs ( gvPlayer2 . hspeed )  >= 4.5 ||  ( gvPlayer2 . stats . weapon == "earth" && gvPlayer2 . vspeed >= 2 )  )  &&  ( gvPlayer2 . anim == "slide" || gvPlayer2 . anim == "ball" )  )  if ( hitTest ( slideshape , gvPlayer2 . shape )  )  { 
 vspeed =  - 2 ; 
coins --  ; 
newActor ( CoinEffect , x , y - 16 )  ; 
popSound ( sndBump , 0 )  ; 
