...
actor [ owner ]  . homingTarget = 0 ; 
  ...
  } ;  returnVal . draw = function (  ) { drawSpriteZ ( 4 , sprShieldInsta , frame , x - camx , y - camy )  ; 
 if ( debug )  { 
 setDrawColor ( 0xff0000ff )  ; 
drawCircle ( x - camx , y - camy , shape . r , false )  ; 
 } 
...
FlameBreath =  ((function(){ let squirrelClassFunction; squirrelClassFunction = function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = WeaponEffect ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  for (var baseProperty in returnVal) { 
 ...
 returnVal . frame = 0.0 ; 
 returnVal . angle = 0 ; 
 returnVal . hasInitializedAngle = false ; 
 returnVal . power = 1.0 ; 
 returnVal . piercing = 0 ; 
 returnVal . perf = 0 ; 
...
drawLightEx ( sprLightFire , 0 , x - camx , y - camy , 0 , 0 , 1.0 / 8.0 , 1.0 / 8.0 )  ; 
 ...
 squirrelClassFunction . hasInitializedAngle = false ; 
...
FireballK =  ((function(){ let squirrelClassFunction; squirrelClassFunction = function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = WeaponEffect ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  for (var baseProperty in returnVal) { 
 ...
 returnVal . timer = null ; 
 returnVal . angle = 0 ; 
 returnVal . element = "fire" ; 
 returnVal . power = 1 ; 
 returnVal . inWaterBool = false ; 
...
timer = 85 + randInt ( 10 )  ; 
 ...
 if ( timer == 0 ) deleteActor ( id )  ; 
  ...
  if ( timer % 5 == 0 ) inWaterBool = inWater ( x , y )  ; 
...
drawLightEx ( sprLightFire , 0 , x - camx , y - camy , 0 , 0 , 1.0 / 4.0 , 1.0 / 4.0 )  ; 
 ...
 returnVal.constructor(...arguments); returnVal.SQUIRREL_CLASS = squirrelClassFunction; return returnVal ;  };  squirrelClassFunction . timer = null ; 
 squirrelClassFunction . angle = 0 ; 
 squirrelClassFunction . element = "fire" ; 
 squirrelClassFunction . power = 1 ; 
 squirrelClassFunction . inWaterBool = false ; 
 squirrelClassFunction.IS_CLASS_DECLARATION = true;  squirrelClassFunction.SQUIRREL_SUPER_CLASS = WeaponEffect;  return squirrelClassFunction; })()) ; 
...
y +=  ( actor [ owner ]  . vspeed )  / 2.0 ; 
 if ( flip ==  - 1 ) flip = int ( x < actor [ owner ]  . x - actor [ owner ]  . hspeed )  ; 
...
frame += 0.25 ; 
 if ( frame > 1 ) deleteActor ( id )  ; 
  ...
  } ;  returnVal . draw = function (  ) { drawSpriteZ ( 3 , sprShieldFire ,  -  ( frame + 1 )  , x - camx , y - camy , 90 , flip * 2 , 0.8 , 0.8 )  ; 
 } ; 
 } 
...
drawCircle ( x - camx , y - camy , shape . r , false )  ; 
 ...
 squirrelClassFunction . blast = true ; 
 squirrelClassFunction.IS_CLASS_DECLARATION = true;  squirrelClassFunction.SQUIRREL_SUPER_CLASS = WeaponEffect;  return squirrelClassFunction; })()) ; 
KonqiIceball =  ((function(){ let squirrelClassFunction; squirrelClassFunction = function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = WeaponEffect ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  for (var baseProperty in returnVal) { 
     if (returnVal.hasOwnProperty(baseProperty) && (typeof returnVal[baseProperty]) !== 'function' && squirrelClassFunction[baseProperty] === undefined) 
         squirrelClassFunction[baseProperty] = returnVal[baseProperty]; 
 } 
 returnVal . element = "earth" ; 
 returnVal . timer = 90 ; 
 returnVal . angle = null ; 
 returnVal . xdelta = null ; 
 returnVal . ydelta = null ; 
 returnVal . xdeltaOriginal = null ; 
 returnVal . ydeltaOriginal = null ; 
...
drawLightEx ( sprLightIce , 0 , x - camx , y - camy , 0 , 0 , 1.0 / 8.0 , 1.0 / 8.0 )  ; 
 ...
 squirrelClassFunction . timer = 90 ; 
 squirrelClassFunction . angle = null ; 
 squirrelClassFunction . xdelta = null ; 
 squirrelClassFunction . ydelta = null ; 
 squirrelClassFunction . xdeltaOriginal = null ; 
 squirrelClassFunction . ydeltaOriginal = null ; 
 squirrelClassFunction.IS_CLASS_DECLARATION = true;  squirrelClassFunction.SQUIRREL_SUPER_CLASS = WeaponEffect;  return squirrelClassFunction; })()) ; 
...
c . hspeed =  - 2 ; 
c . piercing = 4 ; 
 break ;  case "earth" : c = fireWeapon ( ExplodeE2 , x , y , alignment , owner )  ; 
c . power = 4 ; 
