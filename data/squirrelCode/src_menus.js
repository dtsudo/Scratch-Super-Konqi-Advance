...
gvGameMode = pickChar ; 
  ...
  }  , func :  function (  ) { pickCharInitialize ( 2 , true )  ; 
gvGameMode = pickChar ; 
 }  }  ,  { name :  function (  ) {  return gvLangObj [ "menu-commons" ]  [ "back" ]  ;
  }  , func :  function (  ) { cursor = 0 ; 
menu = meMain ; 
...
gvGameMode = pickChar ; 
  ...
  }  , func :  function (  ) { pickCharInitialize ( 2 )  ; 
gvGameMode = pickChar ; 
...
config . fullscreen =  ! config . fullscreen ; 
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . usefilter ? "on" : "off" ]  ;
  return format ( gvLangObj [ "options-menu" ]  [ "usefilter" ]  , val )  ;
  }  , desc :  function (  ) {  return gvLangObj [ "options-menu-desc" ]  [ "usefilter" ]  ;
  }  , func :  function (  ) { config . usefilter =  ! config . usefilter ; 
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  return gvLangObj [ "menu-commons" ]  [ "back" ]  ;
  }  , func :  function (  ) { menu = meOptions ; 
 }  , back :  function (  ) { menu = meOptions ; 
 }  }  ]  ; 
meAccessibility =  [  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . light ? "on" : "off" ]  ;
...
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . weather ? "on" : "off" ]  ;
  return format ( gvLangObj [ "options-menu" ]  [ "weather" ]  , val )  ;
  }  , desc :  function (  ) {  return gvLangObj [ "options-menu-desc" ]  [ "weather" ]  ;
  }  , func :  function (  ) { config . weather =  ! config . weather ; 
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . nearbars ? "on" : "off" ]  ;
  return format ( gvLangObj [ "options-menu" ]  [ "nearbars" ]  , val )  ;
  }  , desc :  function (  ) {  return gvLangObj [ "options-menu-desc" ]  [ "nearbars" ]  ;
  }  , func :  function (  ) { config . nearbars =  ! config . nearbars ; 
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
...
meInput =  [  { name :  function (  ) {  return gvLangObj [ "options-menu" ]  [ "keyboard" ]  ;
 ...
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . showcursor ? "on" : "off" ]  ;
...
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . stickspeed ? "on" : "off" ]  ;
  return format ( gvLangObj [ "options-menu" ]  [ "stickspeed" ]  , val )  ;
  }  , desc :  function (  ) {  return gvLangObj [ "options-menu-desc" ]  [ "stickspeed" ]  ;
  }  , func :  function (  ) { config . stickspeed =  ! config . stickspeed ; 
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . stickactive ? "on" : "off" ]  ;
  return format ( gvLangObj [ "options-menu" ]  [ "stickactive" ]  , val )  ;
  }  , desc :  function (  ) {  return gvLangObj [ "options-menu-desc" ]  [ "stickactive" ]  ;
  }  , func :  function (  ) { config . stickactive =  ! config . stickactive ; 
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  var val = gvLangObj [ "menu-commons" ]  [ config . stickcam ? "on" : "off" ]  ;
  return format ( gvLangObj [ "options-menu" ]  [ "stickcam" ]  , val )  ;
  }  , desc :  function (  ) {  return gvLangObj [ "options-menu-desc" ]  [ "stickcam" ]  ;
  }  , func :  function (  ) { config . stickcam =  ! config . stickcam ; 
fileWrite ( "config.json" , jsonWrite ( config )  )  ; 
 }  }  ,  { name :  function (  ) {  return gvLangObj [ "menu-commons" ]  [ "back" ]  ;
  }  , func :  function (  ) { menu = meOptions ; 
 }  , back :  function (  ) { menu = meOptions ; 
