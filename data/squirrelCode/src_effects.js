...
angle =  ( 360 / 8 )  * randInt ( 8 )  ; 
 ...
 x += hspeed ; 
y += vspeed ; 
 } ;  returnVal . draw = function (  ) { drawSpriteZ ( 4 , sprPoof , floor ( frame )  , x - camx , y - camy , 0 , 0 , 0.5 , 0.5 , 1 )  ; 
 } ; 
 } 
 returnVal.constructor(...arguments); returnVal.SQUIRREL_CLASS = squirrelClassFunction; return returnVal ;  };  squirrelClassFunction . frame = 0.0 ; 
 squirrelClassFunction . angle = 0 ; 
...
popSound ( sndSplash )  ; 
 ...
 if ( frame >= 4 ) deleteActor ( id )  ; 
  ...
  } ;  returnVal . draw = function (  ) { drawSpriteZ ( 7 , sprSplash , floor ( frame )  , x - camx , y - camy , 0 , 0 , 1 , 1 , 0.8 )  ; 
 } ; 
 } 
 returnVal.constructor(...arguments); returnVal.SQUIRREL_CLASS = squirrelClassFunction; return returnVal ;  };  squirrelClassFunction . frame = 0.0 ; 
 squirrelClassFunction . angle = 0 ; 
