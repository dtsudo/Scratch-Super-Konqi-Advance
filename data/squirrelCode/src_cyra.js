...
gvCharacters . Kiki2 =  { name : "Kiki the Cyber Squirrel (Type B)" , shortname : "Kiki" , over : "sprKikiOverworld" , doll : "sprKikiDoll" , normal : "sprKiki2" , fire : "sprKiki2" , ice : "sprKiki2" , air : "sprKiki2" , earth : "sprKiki2" , shock : "sprKiki2" , water : "sprKiki2" , dark : "sprKiki2" , light : "sprKiki2" , pick :  [ 8 , 107 ]  }  ; 
...
drawLightEx ( sprLightFire , 0 , x - camx , y - camy , 0 , 0 , 2.0 / 8.0 , 2.0 / 8.0 )  ; 
 ...
 squirrelClassFunction . piercing = 10 ; 
 squirrelClassFunction.IS_CLASS_DECLARATION = true;  squirrelClassFunction.SQUIRREL_SUPER_CLASS = WeaponEffect;  return squirrelClassFunction; })()) ; 
Kiki2 =  ((function(){ let squirrelClassFunction; squirrelClassFunction = function ( ) { var returnVal = { constructor: function(){} } ;  returnVal = Cyra ( 'DO_NOT_CALL_CONSTRUCTOR' ) ; var baseMethods = { ... returnVal }; var baseConstructor = returnVal.constructor;  for (var baseProperty in returnVal) { 
     if (returnVal.hasOwnProperty(baseProperty) && (typeof returnVal[baseProperty]) !== 'function' && squirrelClassFunction[baseProperty] === undefined) 
         squirrelClassFunction[baseProperty] = returnVal[baseProperty]; 
 } 
...
mySprEarth = sprKiki2 ; 
mySprShock = sprKiki2 ; 
 } ;  returnVal . _typeof = function (  ) {  return "Kiki2" ;
  } ; 
 } 
